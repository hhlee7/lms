...
<header>
  <div class="logo">
  <img src="https://search.pstatic.net/sunny/?src=https%3A%2F%2Fupload.wikimedia.org%2Fwikipedia%2Fcommons%2F9%2F98%2FMicrosoft_Edge_logo_%25282019%2529.svg&type=sc960_832" 
       alt="학교 로고" 
...
<div class="banner">
  ...
  <button onclick="location.href='/login'">로그인 하러 가기</button>
</div>
...
<section class="gallery">
  <div class="gallery-grid">
    <a href="#" onclick="openModal(this)">
      <img class="photo1" src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyNTAyMTBfMTkw%2FMDAxNzM5MTcxMjg2NDAz.ciHXeschx4J9Ile5zWggtmTQJyfHs4JgrnrC9qq_M-Ig.X6_zAeOoznliF0AYIlOFqHqu284T8OYObA0aZ4z_iNIg.JPEG%2FKakaoTalk_20250210_141154684_17.jpg&type=sc960_832" alt="학교 사진 1" />
    </a>
    <a href="#" onclick="openModal(this)">
      <img class="photo2" src="https://search.pstatic.net/sunny/?src=https%3A%2F%2Fimg.lovepik.com%2Fphoto%2F20211130%2Fmedium%2Flovepik-pupils-play-football-picture_501223296.jpg&type=sc960_832" alt="학교 사진 2" />
    </a>
    <a href="#" onclick="openModal(this)">
      <img class="photo3" src="https://search.pstatic.net/common/?src=http%3A%2F%2Fimgnews.naver.net%2Fimage%2F003%2F2016%2F12%2F21%2FNISI20161221_0012516863_web_20161221134239417.jpg&type=sc960_832" alt="학교 사진 3" />
    </a>
    <a href="#" onclick="openModal(this)">
