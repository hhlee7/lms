...
<main class="main-content">
  ...
  <section class="search-section mb-3">
    <form class="row gy-2 gx-3 align-items-center" onsubmit="return false;">
      ...
      <div class="col-md">
        <label for="searchWord" class="form-label fw-semibold">내용 검색</label>
        <div class="input-group">
          <span class="input-group-text"><i class="bi bi-search"></i></span>
          <input type="text" name="searchWord" id="searchWord" class="form-control"
                 value="${page.searchWord != null ? page.searchWord : ''}" placeholder="요청 내용 입력" />
                  ...
                  <c:if test="${list.status == '요청완료'}">
                    <form method="post" action="/admin/changeMaterialRequestStatus">
                      ...
                      <button type="submit" class="btn btn-outline-success btn-sm">
                        <i class="bi bi-check-circle"></i> 요청 수락
                      </button>
                    </form>
                  </c:if>
                </td>
