...
<body>
	...
	<!-- 이름 검색 -->
	<div>
		내용 검색 : <input type="text" name="searchWord" id="searchWord" value="${page.searchWord != null ? page.searchWord : ''}">
	...
	<div>
		...
		<c:if test="${page.prevGroup}">
			<a href="/admin/materialRequestManagement?page=${page.prevGroupPage}&searchWord=${page.searchWord}&searchType=${page.searchType}">«</a>
		</c:if>
		...
		<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
			<c:choose>
				...
				<c:otherwise>
					<a href="/admin/materialRequestManagement?page=${i}&searchWord=${page.searchWord}&searchType=${page.searchType}">[${i}]</a>
				</c:otherwise>
			</c:choose>
		</c:forEach>
		...
		<c:if test="${page.nextGroup}">
			<a href="/admin/materialRequestManagement?page=${page.nextGroupPage}&searchWord=${page.searchWord}&searchType=${page.searchType}">»</a>
		</c:if>
	</div>
</body>
</html>