...
<body>
		...
		<c:otherwise>
			...
			<c:forEach var="list" items="${lectureList}">
				<tr>
					...
					<td>${list.endDate}</td>
					<td>
						<!-- 해당 수업에 배정된 배차 정보가 없을 시 / 있다면 배차 정보 출력 -->
						<c:choose>
	...
	<div>
		...
		<c:if test="${page.prevGroup}">
			<a href="/admin/lectureManagement?page=${page.prevGroupPage}&searchWord=${page.searchWord}&searchType=${page.searchType}">«</a>
		</c:if>
		...
		<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
			<c:choose>
				...
				<c:otherwise>
					<a href="/admin/lectureManagement?page=${i}&searchWord=${page.searchWord}&searchType=${page.searchType}">[${i}]</a>
				</c:otherwise>
			</c:choose>
		</c:forEach>
		...
		<c:if test="${page.nextGroup}">
			<a href="/admin/lectureManagement?page=${page.nextGroupPage}&searchWord=${page.searchWord}&searchType=${page.searchType}">»</a>
		</c:if>
	</div>
</body>
</html>