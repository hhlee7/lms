...
<body>
	...
	<div>
		...
		<c:if test="${page.prevGroup}">
			<a href="/admin/enrollmentCancelList?page=${page.prevGroupPage}&searchWord=${page.searchWord}&searchType=${page.searchType}">«</a>
		</c:if>
		...
		<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
			<c:choose>
				...
				<c:otherwise>
					<a href="/admin/enrollmentCancelList?page=${i}&searchWord=${page.searchWord}&searchType=${page.searchType}">[${i}]</a>
				</c:otherwise>
			</c:choose>
		</c:forEach>
		...
		<c:if test="${page.nextGroup}">
			<a href="/admin/enrollmentCancelList?page=${page.nextGroupPage}&searchWord=${page.searchWord}&searchType=${page.searchType}">»</a>
		</c:if>
	</div>
</body>
</html>